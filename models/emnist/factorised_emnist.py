...
for i in range(0, len(train_images)):
    train_images[i] = np.fliplr(np.rot90(train_images[i], 3))
...
def make_generator_model():
    ...
    model.add(layers.Conv2DTranspose(64, (5, 1), strides=(2, 2), padding='same', use_bias=False))
    model.add(layers.Conv2DTranspose(64, (1, 5), strides=(2, 2), padding='same', use_bias=False))
